...
public class SupportWebActivity extends Activity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.supportweb);
		...
		if(bundle!=null)
		{
			...
			mWeb.loadUrl(VariableConstants.SUPPORT_LINK+url);
		}
	}
